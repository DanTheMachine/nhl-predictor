...
03/19/2026,7:00 PM EDT,OTT Senators,NYI Islanders,60.3%,39.7%,3.08,2.44,5.52,6.0,UNDER,-0.48,-152,+152,-125,+115,,,,,,+5.9%,-5.9%,HOME ML,3.2%,HOME -1.5,+7.4%,53.0%,48.1%,54.5%,46.3%,.891,.917,,,23.7%,16.0%,72.4%,81.1%,99.2,100.6,ESPN,20260319OTTNYI,3,2,OTT,5,1,1,0,,,
03/20/2026,7:00 PM EDT,TOR Maple Leafs,CAR Hurricanes,18.0%,82.0%,2.28,3.71,5.99,6.0,PASS,-0.01,+456,-456,+185,-205,+1.0,-140,+130,-115,+105,-16.3%,+16.3%,AWAY ML,11.9%,AWAY -1.5,+7.2%,45.6%,59.8%,47.6%,55.5%,.899,.901,,,19.7%,22.6%,83.0%,80.0%,100.2,99.1,ESPN,20260320TORCAR,,,,,,,,,,x`;

const weightedBetSpreadsheetCsv = `Date,Game Time,Home,Away,Home Win %,Away Win %,Home Goals,Away Goals,Model Total,Vegas O/U,O/U Rec,O/U Edge,Home ML (Model),Away ML (Model),Vegas Home ML,Vegas Away ML,Vegas Puck Line,Home PL Odds,Away PL Odds,Over Odds,Under Odds,Home ML Edge,Away ML Edge,ML Value Side,ML Kelly %,Puck Line Rec,Puck Line Edge,Home CF%,Away CF%,Home xGF%,Away xGF%,Home SV%,Away SV%,Home Goalie Override,Away Goalie Override,Home PP%,Away PP%,Home PK%,Away PK%,Home PDO,Away PDO,Odds Source,LookupKey,Actual Home Goals,Actual Away Goals,Actual Winner,Actual Total,ML Hit,O/U Hit,PL,ML Bet,O/U Bet,PL Bet
03/19/2026,7:00 PM ET,COL Avalanche,CHI Blackhawks,60.0%,40.0%,3.20,2.10,5.30,5.5,UNDER,-0.20,-150,+150,-110,+100,-1.5,+130,-150,-110,-110,+7.5%,-7.5%,HOME ML,3.1%,HOME -1.5,+4.5%,56.4%,45.0%,55.8%,44.2%,.926,.903,-,-,25.5%,18.0%,83.0%,76.0%,101.3,98.7,ESPN,20260319COLCHI,4,2,COL,6,1,0,1,2,1.5,
03/19/2026,8:00 PM ET,BOS Bruins,TOR Maple Leafs,54.0%,46.0%,3.10,2.80,5.90,6.0,OVER,+0.45,-117,+117,+105,-125,+1.5,-165,+145,-105,-115,+5.2%,-5.2%,HOME ML,2.2%,PASS,-,49.0%,45.6%,46.4%,47.6%,.914,.899,-,-,25.6%,19.7%,77.2%,83.0%,101.9,100.2,ESPN,20260319BOSTOR,2,5,TOR,7,0,1,0,,,`;

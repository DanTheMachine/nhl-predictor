...
export function SingleGamePanel(props: SingleGamePanelProps) {
  ...
  return (
    <div className="nhl-card" style={{ marginBottom: 20, border: "1px solid rgba(100,180,255,0.18)", background: "rgba(100,180,255,0.03)" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
        <div>
          <div style={{ fontSize: 11, color: "#8faabf", letterSpacing: 3, marginBottom: 4 }}>SINGLE GAME TOOLS</div>
          <div style={{ fontSize: 12, color: "#b3c0cc" }}>
        ...
        <button
          ...
          style={{
            ...
            border: `1px solid ${isOpen ? "rgba(56,189,248,0.35)" : "rgba(100,180,255,0.15)"}`,
            borderRadius: 4,
            padding: "8px 14px",
            color: isOpen ? "#7dd3fc" : "#9fb3c8",
            fontSize: 11,
            fontWeight: 900,
            letterSpacing: 2,
